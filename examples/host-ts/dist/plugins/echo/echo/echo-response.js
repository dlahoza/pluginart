...
class EchoResponse {
    ...
    static getRootAsEchoResponse(bb, obj) {
        return (obj || new EchoResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsEchoResponse(bb, obj) {
    ...
    static startEchoResponse(builder) {
        builder.startObject(1);
    }
    static addOutput(builder, outputOffset) {
        builder.addFieldOffset(0, outputOffset, 0);
    }
    static endEchoResponse(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createEchoResponse(builder, outputOffset) {
